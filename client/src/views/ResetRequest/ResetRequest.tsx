    ...
    >
      ...
      >
        <Stack spacing={1} className="flex w-full items-center">
          ...
          <Typography className="px-8" variant="subtitle2" component="h1">
            Enter the email address associated with your account and we'll send
            you a link to reset your password.
          </Typography>
        </Stack>
        <Typography className="" variant="subtitle2" component="h1">
          Enter the email address associated with your account and we'll send
          you a link to reset your password.
        </Typography>
      </Stack>
      <Stack spacing={4} className="flex w-full items-center">
        ...
        >
          <div className="modal">
            If an account associated with the provided email exists, you will
            receive a password reset link in your inbox.
          </div>
        </Popup>
      </Stack>
    </Box>
